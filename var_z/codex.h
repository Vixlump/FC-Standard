...
vector <int32_t> active_int32;
vector <int16_t> active_int16;
vector <int8_t> active_int8;
vector <bool> active_bool;
vector <float> active_float;
vector <double> active_double;
vector <triple> active_triple;
struct assignment { uint64_t name; uint64_t line; };
vector <assignment> active_assignments;
vector <assignment> function_assignments;
